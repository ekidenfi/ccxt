...
class ekiden(Exchange, ImplicitAPI):
    ...
    def compute2_4h_volumes_from_candles(self, market: Market) -> dict:
        try:
            since = self.milliseconds() - 24 * 60 * 60 * 1000
            candles = self.fetch_ohlcv(market['symbol'], '1m', since, 1440)
            baseSum = 0
            quoteSum = 0
            infoMarket = market['info'] or {}
    ...
    def fetch_positions(self, symbols: Strings = None, params={}) -> List[Position]:
        ...
        response = self.v1PrivateGetUserPortfolio(params)
    ...
    def fetch_ticker(self, symbol: str, params={}) -> Ticker:
        ...
        if missingQuote and missingBase:
            fromCandles = self.compute2_4h_volumes_from_candles(market)
    ...
    def create_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={}) -> Order:
        ...
        if reduceOnlyParam:
            try:
                allPositions = self.fetch_positions(None, {})
        ...
        if postOnlyParam:
            ...
            try:
                ob = self.fetch_order_book(market['symbol'], 1)
