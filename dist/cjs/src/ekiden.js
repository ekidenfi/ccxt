...
var ekiden$1 = require('./abstract/ekiden.js');
...
class ekiden extends ekiden$1["default"] {
    ...
    serializeActionPayload(payload) {
        ...
        if (payload['type'] === 'leverage_assign') {
            ...
            throw new errors.NotSupported(this.id + ' unsupported payload type: ' + payload['type']);
        }
    ...
    signMessage(message) {
        ...
        const sig = ed25519.ed25519.sign(message, pk);
